...
namespace GamepadInput
{
    ...
    public static class GamePad
    {
        ...
        /// ボタンを押したときに反応
        /// </summary>
        /// <param name="button">入力するボタン</param>
        /// <param name="controlIndex">ゲームパッドの番号</param>
        /// <returns></returns>
        ...
        /// スティックとDパッドの入力を受ける
        /// </summary>
        /// <param name="axis">入力を受けるスティック／Dパッド</param>
        /// <param name="controlIndex">ゲームパッドの番号</param>
        /// <param name="raw">rawがfalseの時、Indexの値はdeadspotで返される
        /// if raw is false then the controlIndex will be returned with a deadspot</param>
        /// <returns></returns>
